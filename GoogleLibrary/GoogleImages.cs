...
namespace GoogleLibrary
{
    public class GoogleImages
    {
        ...
        // completed uri with querry would look like: https://www.googleapis.com/customsearch/v1?key=AIzaSyBTwASr75UbGxxT9qSJJrOkVNxk3_1bOvI&cx=faa9aa8097b8b7a8d&q=asuna
        ...
        // TODO: will prolly need to update this to be list of strings
        public GoogleImages()
        {
        ...
        //public void SearchGoogleImages(string searchParams)
        //{
        //    _searchParams = searchParams;
        //    GData = InitlializeGoogleImagesFromWebApi();
        //}
